const distributions = [
    ...
    { name: "Manjaro", version: "24.0.6 x86_64", icon: "https://upload.wikimedia.org/wikipedia/commons/3/3e/Manjaro-logo.svg", downloadLink: "https://download.manjaro.org/gnome/24.0.6/manjaro-gnome-24.0.6-240812-linux69.iso", description: "User-friendly Arch Linux-based distribution.", websiteLink: "https://manjaro.org/"},
    ...
    { name: "Zorin OS", version: "17.1 Core x86_64", icon: "https://upload.wikimedia.org/wikipedia/commons/7/70/Zorin_OS.svg", downloadLink: "https://zorin.mirrors.itworxx.de/17/Zorin-OS-17.1-Core-64-bit-r2.iso", description: "Easy transition from Windows to Linux.", websiteLink: "https://zorin.com/os/"},
    { name: "Rocky Linux", version: "DVD 9.4 x86_64", icon: "https://upload.wikimedia.org/wikipedia/commons/7/77/Rocky_Linux_logo.svg", downloadLink: "https://download.rockylinux.org/pub/rocky/9/isos/x86_64/Rocky-9.4-x86_64-dvd.iso", description: "Enterprise-ready, RHEL-compatible Linux distribution.", websiteLink: "https://rockylinux.org/"},
    ...
    { name: "CachyOS", version: "240818 x86_64", icon: "https://upload.wikimedia.org/wikipedia/commons/b/b8/CachyOS_Logo.svg", downloadLink: "https://iso.cachyos.org/desktop/240818/cachyos-desktop-linux-240818.iso", description: "Arch-based, optimized for performance and security.", websiteLink: "https://cachyos.org/"},
    ...
    { name: "Oracle Linux", version: "9.4 x86_64", icon: "https://upload.wikimedia.org/wikipedia/commons/4/46/Oracle_linux_logo.svg", downloadLink: "https://yum.oracle.com/ISOS/OracleLinux/OL9/u4/x86_64/OracleLinux-R9-U4-x86_64-boot.iso", description: "Enterprise Linux optimized for Oracle.", websiteLink: "https://www.oracle.com/linux/"},
    { name: "SDesk", version: "2024.06.24 x86_64", icon: "https://i0.wp.com/stevestudios.net/wp-content/uploads/2024/02/squid-2.png", downloadLink: "https://stevestudios.net/wp-content/uploads/2024/06/sdesk-2024.06.24-x86_64.iso", description: "A minimalist distribution.", websiteLink: "https://stevestudios.net/"},
    { name: "Solus", version: "4.5 x86_64", icon: "https://getsol.us/imgs/solus.png", downloadLink: "https://downloads.getsol.us/isos/4.5/Solus-4.5-Budgie.iso", description: "A distribution that includes the Budgie desktop.", websiteLink: "https://getsol.us/"},
    { name: "Pisi Linux", version: "2.3.4 (Nar) x86_64", icon: "https://i0.wp.com/old-sites.pisilinux.org/uploads/PisiLinux_Branding/pisi-logo-magenta.png", downloadLink: "https://ftp.linux.org.tr/pisilinux/iso/KDE/latest/Pisi-Linux-2.3.4-KDE5-Nar-x86_64.iso", description: "A Turkish-made Linux with its own package manager.", websiteLink: "https://pisilinux.org/"},
    ...
    { name: "BunsenLabs", version: "240123 (Boron) x86_64", icon: "https://avatars.githubusercontent.com/u/11029023?s=200&v=4", downloadLink: "https://ddl.bunsenlabs.org/ddl/boron-1-240123-amd64.hybrid.iso", description: "Lightweight, customizable, and minimalist Linux.", websiteLink: "https://www.bunsenlabs.org/"},
