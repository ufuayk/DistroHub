const distributions = [
    { name: "Ubuntu", version: "24.04.1 LTS (Noble Numbat) x86_64", icon: "https://assets.ubuntu.com/v1/29985a98-ubuntu-logo32.png", downloadLink: "https://releases.ubuntu.com/noble/ubuntu-24.04.1-desktop-amd64.iso", description: "User-friendly and popular Linux distribution." },
    ...
    { name: "EndeavourOS", version: "2024.06.25 x86_64", icon: "https://i0.wp.com/endeavouros.com/wp-content/uploads/2021/04/eos-icon.png", downloadLink: "https://mirror.alpix.eu/endeavouros/iso/EndeavourOS_Endeavour-2024.06.25.iso", description: "Flexible, user-friendly Arch-based distribution." },
    ...
    { name: "Kali Linux", version: "2024.3 x86_64", icon: "https://upload.wikimedia.org/wikipedia/commons/2/2b/Kali-dragon-icon.svg", downloadLink: "https://cdimage.kali.org/kali-2024.3/kali-linux-2024.3-installer-amd64.iso", description: "Powerful toolkit for ethical hacking and security." },
    ...
    { name: "Oracle Linux", version: "9.4 x86_64", icon: "https://upload.wikimedia.org/wikipedia/commons/4/46/Oracle_linux_logo.svg", downloadLink: "https://yum.oracle.com/ISOS/OracleLinux/OL9/u4/x86_64/OracleLinux-R9-U4-x86_64-boot.iso", description: "Enterprise Linux optimized for Oracle." },
    { name: "SDesk", version: "2024.06.24 x86_64", icon: "https://i0.wp.com/stevestudios.net/wp-content/uploads/2024/02/squid-2.png", downloadLink: "https://stevestudios.net/wp-content/uploads/2024/06/sdesk-2024.06.24-x86_64.iso", description: "A minimalist distribution." },
    ...
    { name: "Pisi Linux", version: "2.3.4 (Nar) x86_64", icon: "https://i0.wp.com/old-sites.pisilinux.org/uploads/PisiLinux_Branding/pisi-logo-magenta.png", downloadLink: "https://ftp.linux.org.tr/pisilinux/iso/KDE/latest/Pisi-Linux-2.3.4-KDE5-Nar-x86_64.iso", description: "A Turkish-made Linux with its own package manager." },
    { name: "deepin", version: "23 x86_64", icon: "https://upload.wikimedia.org/wikipedia/commons/f/f5/Deepin_logo.svg", downloadLink: "https://cdimage.deepin.com/releases/23/amd64/deepin-desktop-community-23-amd64.iso", description: "A modern OS with a macOS-like deepin desktop." },
    { name: "Tails", version: "6.6 x86_64", icon: "https://tails.net/contribute/how/promote/material/logo/tails-logo-drawing.svg", downloadLink: "https://download.tails.net/tails/stable/tails-amd64-6.6/tails-amd64-6.6.img", description: "A Debian-based OS focused on privacy and security." },
    { name: "RebornOS", version: "2024.07.27 x86_64", icon: "https://rebornos.org/wp-content/uploads/2022/08/Reborn-Blue-Black.svg", downloadLink: "https://cdn.soulharsh007.dev/RebornOS-ISO/rebornos_iso-2024.07.27-x86_64.iso", description: "A Arch-based distro. with customizable desktops." },
    { name: "Peppermint OS", version: "Debian x86_64", icon: "https://codeberg.org/Peppermint_OS/Logos-Sliders/raw/branch/master/logo.svg", downloadLink: "https://mirror.ossplanet.net/peppermint/iso/XFCE/PeppermintOS-Debian-64.iso", description: "A lightweight, cloud-focused Linux distribution." },
    { name: "Raspberry Pi OS", version: "2024-07-04 Bookworm ARM64", icon: "https://upload.wikimedia.org/wikipedia/tr/c/cb/Raspberry_Pi_Logo.svg", downloadLink: "https://downloads.raspberrypi.com/raspios_arm64/images/raspios_arm64-2024-07-04/2024-07-04-raspios-bookworm-arm64.img.xz", description: "An OS optimized for Raspberry Pi devices." },
    { name: "BunsenLabs", version: "240123 (Boron) x86_64", icon: "https://avatars.githubusercontent.com/u/11029023?s=200&v=4", downloadLink: "https://ddl.bunsenlabs.org/ddl/boron-1-240123-amd64.hybrid.iso", description: "Lightweight, customizable, and minimalist Linux." },
    { name: "Athena OS", version: "v23.11 (Nyx) x86_64", icon: "https://avatars.githubusercontent.com/u/107514694?s=200&v=4", downloadLink: "https://github.com/Athena-OS/athena/releases/download/v23.11/athena-rolling-x86_64.iso", description: "Cybersecurity-focused, secure, and modern OS." },
    { name: "PCLinuxOS", version: "2024.04 x86_64", icon: "https://upload.wikimedia.org/wikipedia/commons/8/89/PCLinuxOS_logo.svg", downloadLink: "https://ftp.nluug.nl/os/Linux/distr/pclinuxos/pclinuxos/iso/pclinuxos64-kde-2024.04.iso", description: "User-friendly and versatile Linux distribution." }
