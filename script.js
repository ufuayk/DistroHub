const distributions = [
    ...
    { name: "Oracle Linux", version: "9.4 x86_64", icon: "https://blog.gleb.ca/wp-content/uploads/2022/10/Penguin-GdOipk.png", downloadLink: "https://yum.oracle.com/ISOS/OracleLinux/OL9/u4/x86_64/OracleLinux-R9-U4-x86_64-boot.iso", description: "An enterprise-grade Linux, optimized for Oracle environments." },
    { name: "SDesk", version: "2024.06.24 x86_64", icon: "https://i0.wp.com/stevestudios.net/wp-content/uploads/2024/02/squid-2.png?w=256&ssl=1", downloadLink: "https://stevestudios.net/wp-content/uploads/2024/06/sdesk-2024.06.24-x86_64.iso", description: "A minimalist distribution offering a streamlined desktop experience." },
    { name: "Solus", version: "4.5 x86_64", icon: "https://getsol.us/imgs/solus.png", downloadLink: "https://downloads.getsol.us/isos/4.5/Solus-4.5-Budgie.iso", description: "An independent distribution featuring the modern Budgie desktop." }
